    ...
    <form wire:submit="save">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                {{-- Imagen del producto --}}
                <div class="card" x-data="{ preview: '{{ $storefrontImageUrl }}' }">
                    ...
                    <div class="flex gap-5 items-start flex-wrap">
                        ...
                        <div class="flex-1 min-w-0 space-y-2">
                            ...
                            <input wire:model.blur="storefrontImageUrl"
                                   x-on:blur="preview = $event.target.value"
                                   type="url"
                                   class="form-input"
                                   placeholder="https://i.imgur.com/abc123.jpg">
                            @error('storefrontImageUrl') <p class="form-error">{{ $message }}</p> @enderror
                            <p class="text-xs text-gray-400 leading-relaxed">
                                Subí la foto a
                                <a href="https://imgur.com/upload" target="_blank" class="text-indigo-500 hover:underline">Imgur</a>,
                                <a href="https://imgbb.com" target="_blank" class="text-indigo-500 hover:underline">ImgBB</a>
                                u otro servicio gratuito y pegá el link directo a la imagen.
                                La imagen es opcional.
                            </p>
                            @if($storefrontImageUrl)
                                <button type="button"
                                        wire:click="$set('storefrontImageUrl', '')"
                                        x-on:click="preview = ''"
