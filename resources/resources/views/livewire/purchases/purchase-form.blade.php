<div>
    <div class="page-header">
        <div>
            ...
            <h1 class="page-title">{{ $orderId ? 'Editar Orden de Compra' : 'Nueva Orden de Compra' }}</h1>
        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="form-label">Almacén destino <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="form-label">Fecha de pedido <span class="text-red-500">*</span></label>
                            <input wire:model="orderDate" type="date" class="form-input">
                            @error('orderDate') <p class="form-error">{{ $message }}</p> @enderror
                        </div>

                        <div>
                            <label class="form-label">Fecha esperada de entrega</label>
                            <input wire:model="expectedDate" type="date" class="form-input">
                        </div>

                        <div>
                            <label class="form-label">Referencia / Nro. cotización</label>
                            <input wire:model="reference" type="text" class="form-input" placeholder="Ej: COT-001">
                        </div>
                ...
                <div class="card">
                    <div class="flex items-center justify-between mb-4">
                        <h2 class="text-sm font-semibold text-gray-700">Productos a comprar</h2>
                        ...
                        @foreach($items as $index => $item)
                            <div class="border border-gray-100 rounded-lg p-3 bg-gray-50">
                                <div class="grid grid-cols-12 gap-2 items-end">
                                    ...
                                    {{-- Subtotal + eliminar --}}
                                    <div class="col-span-1 flex items-end justify-end gap-1">
                                        <button type="button" wire:click="removeItem({{ $index }})"
                                                class="text-red-400 hover:text-red-600 p-1 mt-1" title="Eliminar línea">
            ...
            <div class="space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            <label class="form-label">Flete / envío</label>
                            <input wire:model.blur="shippingCost" type="number" step="0.01" min="0" class="form-input">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <a href="{{ route('purchases.index') }}" class="btn-secondary w-full text-center">Cancelar</a>
                </div>
