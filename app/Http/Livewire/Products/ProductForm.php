...
class ProductForm extends Component
{
    ...
    public function save(): void
    {
        ...
        $data = [
            ...
            'conversion_factor' => $this->conversionFactor !== '' ? (float) $this->conversionFactor : null,
            'status'            => $this->status,
            'cost'              => $this->cost !== '' ? (float) $this->cost : null,
            'standard_cost'     => $this->standardCost !== '' ? (float) $this->standardCost : null,
            'price'             => $this->price !== '' ? (float) $this->price : null,
            'min_price'         => $this->minPrice !== '' ? (float) $this->minPrice : null,
            'margin_percent'    => $this->marginPercent !== '' ? (float) $this->marginPercent : null,
            'stock_minimum'     => $this->stockMinimum !== '' ? (float) $this->stockMinimum : null,
            'stock_maximum'     => $this->stockMaximum !== '' ? (float) $this->stockMaximum : null,
            'reorder_point'     => $this->reorderPoint !== '' ? (float) $this->reorderPoint : null,
